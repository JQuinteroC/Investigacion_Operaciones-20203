def funcion_lote(x, funcion_recursiva):
    ...
    """
    if x == 0:
        return x + funcion_recursiva * (0.2**x)

    return 7 * x + funcion_recursiva * (0.2**x)
...
if __name__ == "__main__":
    ...
    solucion = [(14.25486, 10), (13.39157, 8), (13.24673, 8)]
    for i in range(len(solucion)):
        print(
            f'En el dia de producción {i+1}, la cantidad optima de lotes de vacunas a producir es de {solucion[i][1]} con un con un costo de {solucion[i][0]*100}$')
